...
import VoidAgencyMethodPage from './pages/VoidAgencyMethodPage';
...
export default function App() {
  ...
  if (
    ...
    window.location.pathname === '/void-agency'
  ) {
    return <VoidAgencyMethodPage />;
  }
...
function HomePage() {
  ...
  return (
    <div className="relative min-h-screen bg-canvas text-ink font-sans overflow-x-hidden selection:bg-ink selection:text-canvas md:cursor-none" ref={containerRef}>
      ...
      >
        <div className="pointer-events-auto hover-target flex flex-col items-start cursor-pointer">
        ...
        <div className="pointer-events-auto flex flex-col items-end gap-2 text-xs font-sans tracking-[0.2em] font-medium uppercase mix-blend-difference select-none">
          <a href="#selected-works" data-cursor-text="WORK" className="hover-target relative group overflow-visible p-2 -m-2">
          ...
          <a href="/method" data-cursor-text="METHOD" className="hover-target relative group overflow-visible p-2 -m-2">
      ...
      <main className="w-full">
        ...
        <section className="relative w-full h-screen flex flex-col justify-end pb-12 px-4 md:px-16 pt-32 overflow-hidden">
          ...
          >
            {isLoaded && (
               <svg viewBox="0 0 1000 300" className="w-[100vw] md:w-[85vw] h-auto overflow-visible">
                 <defs>
           ...
           <motion.div 
             ...
             className="w-full flex flex-col md:flex-row justify-between items-start md:items-end border-b border-ink/20 pb-8 uppercase font-sans tracking-[0.2em] text-[10px] md:text-xs gap-8 md:gap-0"
           >
             <span className="max-w-[250px] md:max-w-xs leading-relaxed text-ink/70">
               McCombs student and Void Agency founder building technical SEO systems, AI-search discoverability workflows, and finance/data tools. Based in Austin.
             </span>
             <span className="text-ink/40">Trace the work</span>
           </motion.div>
        </section>
        ...
        <section id="selected-works" className="w-full py-32 bg-ink text-canvas selection:bg-canvas selection:text-ink relative flex flex-col border-t border-canvas/10">
           ...
           <div className="max-w-[1800px] mx-auto w-full px-4 md:px-16 mb-48 md:mb-64 relative pt-16">
             ...
             <div className="grid grid-cols-1 md:grid-cols-12 gap-0 md:gap-8 items-stretch pt-24">
               ...
               {/* Right Column Canvas */}
               <a href="/atlas" className="md:col-span-8 block overflow-hidden hover-target relative h-[60vh] md:h-[90vh] border border-canvas/20 order-1 md:order-2 origin-right group/atlas" data-cursor-text="ATLAS">
                 ...
                 <div className="absolute left-6 bottom-6 z-20 flex items-center gap-4 text-[10px] uppercase tracking-[0.28em] text-canvas/70 transition-colors group-hover/atlas:text-canvas">
                   ...
                   <span>View Atlas Case Study</span>
                 ...
                 <ScrollReveal delay={0.2} className="absolute bottom-8 right-0 pointer-events-none z-10 -mr-4 md:-mr-16">
                   <h4 className="text-[12vw] md:text-[8vw] lg:text-[10vw] font-serif text-canvas leading-[0.85] font-light uppercase tracking-tighter text-right">
         ...
         <div className="w-full relative py-20 bg-ink" id="systems">
            <div className="max-w-[1800px] mx-auto w-full px-4 md:px-16 mb-48 md:mb-64 relative pt-16">
             ...
             <div className="grid grid-cols-1 md:grid-cols-12 gap-0 md:gap-8 items-stretch pt-24 pb-48">
               ...
               {/* Left Column Canvas */}
               <div className="md:col-span-8 overflow-hidden hover-target relative h-[60vh] md:h-[90vh] border border-canvas/20 origin-left group" data-cursor-text="OBSERVE">
           ...
           {/* Project 03 - Void */}
           <a href="/method" className="w-full mt-32 md:mt-64 pt-32 pb-48 relative min-h-[60vh] md:min-h-[80vh] flex flex-col items-center justify-center border-t border-b border-canvas/10 my-32 hover-target bg-ink overflow-hidden group" data-cursor-text="METHOD">
              <Suspense fallback={null}><GeometricPattern /></Suspense>
              <div className="relative z-10 flex flex-col items-center">
                ...
                <ScrollReveal delay={0.2} blur={false}>
                  <h4 className="text-[20vw] leading-none font-serif tracking-tighter uppercase text-canvas pb-8 opacity-90 transition-opacity duration-1000">
                ...
                <ScrollReveal delay={0.6}>
                  <MagneticButton className="mt-16">
                    <span className="inline-block text-canvas border border-canvas/20 rounded-full px-8 py-4 uppercase font-sans text-xs tracking-widest group-hover:bg-canvas group-hover:text-ink transition-colors backdrop-blur-sm">View Void Method</span>
                  </MagneticButton>
                </ScrollReveal>
              </div>
           </a>
           ...
           <div className="max-w-[1800px] mx-auto w-full grid grid-cols-1 md:grid-cols-12 gap-16 items-start">
              ...
              <div className="md:col-span-9 flex flex-col w-full text-ink">
                 ...
                 <div className="pt-32 w-full flex justify-start md:justify-end">
                   <a href="#selected-works" className="hover-target text-ink text-[10px] font-sans tracking-widest uppercase border-b border-ink/30 pb-2 inline-block hover:border-ink transition-colors">View Work ↘</a>
                 </div>
              </div>
           </div>
        </section>
           ...
           <div className="px-4 md:px-16 relative z-10 w-full flex flex-col">
              <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 border-b border-canvas/20 pb-16 md:pb-32">
                 <div className="md:col-span-8 flex flex-col items-start justify-end">
                    ...
                    <ScrollReveal delay={0.2} blur={false}>
                      <a href="mailto:sulayman.bowles@gmail.com" className="group flex items-center gap-6 hover-target cursor-none w-fit">
                        <span className="text-xl md:text-3xl font-sans font-light tracking-widest uppercase pb-2 border-b-2 border-canvas/20 group-hover:border-canvas transition-colors">
                          sulayman.bowles@gmail.com
                        </span>
                        <div className="w-12 h-12 rounded-full border border-canvas/20 flex items-center justify-center group-hover:bg-canvas group-hover:text-ink transition-colors">
                 ...
                 <div className="md:col-span-4 flex flex-col justify-end items-start md:items-end w-full space-y-16">
                    ...
                    <ScrollReveal delay={0.4} blur={false}>
                        <div className="grid grid-cols-2 gap-x-12 gap-y-6 text-[10px] uppercase font-sans tracking-[0.2em] opacity-70 w-full">
                           <a href="#" className="hover-target hover:text-canvas/100 hover:opacity-100 transition-opacity border-b border-transparent hover:border-canvas pb-1">LinkedIn</a>
                           <a href="#" className="hover-target hover:text-canvas/100 hover:opacity-100 transition-opacity border-b border-transparent hover:border-canvas pb-1">GitHub</a>
                           <a href="/method" className="hover-target hover:text-canvas/100 hover:opacity-100 transition-opacity border-b border-transparent hover:border-canvas pb-1">Void Agency</a>
                           <a href="#" className="hover-target hover:text-canvas/100 hover:opacity-100 transition-opacity border-b border-transparent hover:border-canvas pb-1">Resume</a>
                           <a href="#" className="hover-target hover:text-canvas/100 hover:opacity-100 transition-opacity border-b border-transparent hover:border-canvas pb-1">Writing</a>
                           <a href="mailto:sulayman.bowles@gmail.com" className="hover-target hover:text-canvas/100 hover:opacity-100 transition-opacity border-b border-transparent hover:border-canvas pb-1">Email</a>
                        </div>
                     </ScrollReveal>
                 </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center text-[10px] uppercase font-sans tracking-[0.2em] text-canvas/40 py-8 gap-4 md:gap-0">
                 ...
                 <a href="#top" className="hover-target hover:text-canvas transition-colors flex items-center gap-2">
